...
export default function RegisterPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white overflow-hidden relative">
      ...
      {/* Glow effects */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-emerald-600/5 rounded-full blur-3xl" />
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-3 text-center">
            ...
            <p className="text-white/40 font-mono text-xs sm:text-sm">
              Crea tu cuenta y comienza a analizar tu código
            </p>
          </div>
